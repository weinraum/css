...
$var1 = 'erste'; $data[$var1] = (!is_array($POST[$var1])?array($POST[$var1]):$POST[$var1]);
$var1 = 'zweite'; $data[$var1] = (!is_array($POST[$var1])?array($POST[$var1]):$POST[$var1]);
$var1 = 'dritte'; $data[$var1] = (!is_array($POST[$var1])?array($POST[$var1]):$POST[$var1]);
