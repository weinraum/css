...
<label class="control-label" for="id_<?php echo $var; ?>">Welches Icon soll eingelendet werden?</label>
<div class="controls">
...
<option<?php echo $App::getSelectDATA($POST[$var], 'terroir'); ?>>Terroir</option>
<option<?php echo $App::getSelectDATA($POST[$var], 'winzer'); ?>>Winzer</option>
<option<?php echo $App::getSelectDATA($POST[$var], 'weine'); ?>>Weine</option>
<!-- <option disabled="disabled">----</option>
<option<?php echo $App::getSelectDATA($POST[$var], 'passend'); ?>>Zu was passend</option>
<option<?php echo $App::getSelectDATA($POST[$var], 'wei_pass'); ?>>Weine</option>
<option<?php echo $App::getSelectDATA($POST[$var], 'zubereitung'); ?>>Zubereitungen</option>
-->
</select>
</div>
</div>
