...
<header>    
<div class=" top-desk ">
<?php if( !isset($_nohead_spam) OR (isset($_nohead_spam) AND $_nohead_spam ==="no")) { ?>
...
<a href="/weinliste/weine_waehlen" class="weinliste 3 <?php echo((isset($nav_show_weinliste) == 1 AND $nav_show_weinliste == 'yes') ? ' active' : '') ?>">Weinliste</a>
...
<?php
if ( isset($bread_regionen) AND $bread_regionen == "yes" AND isset($content[0]['bread'])  ) { ?>
<div class=" bread-inner regionen">
<?php echo $content[0]['bread']!==""?$content[0]['bread']:""; ?>
<?php
}
if ( isset($bread_regionen) AND $bread_regionen == "yes" AND !isset($content[0]['bread'])  ) { }

if ( $show_winzer_bread == "yes" AND isset($content[0]['bread']) AND isset($content[0]['bread_lg']) ) {?>
<div class=" bread-inner winzer">
<p class="d-block d-md-none">
<?php echo $content[0]['bread']; ?>
</p>
<p class="d-none d-md-block">
<?php echo $content[0]['bread_lg']; ?>
</p>
<?php
}
if ( $show_winzer_bread == "yes" AND !isset($content)  ) {  ?>
<p><span class='letzt' >Winzer</span></p>
<?php
}
...
<p><a href = "/weinraum/geschmackpost">Weine Ihrer letzten GeschmackPost</a>
<?php if ( $showEinen == 1) { 
...
<?php ?>
<p><a href = "/" class="head warenkorb">Warenkorb</a><span class="sep">&nbsp;››&nbsp;</span><span class="letzt">Kasse</span></p>
<?php }
...
<a href = "<?php echo $linkBread1 ?>"><?php echo $txtBread1 ?></a><span class="sep">&nbsp;››&nbsp; </span><span class="letzt"><?php echo $txtBread2 ?></span>
<?php } else { ?>
<a href = "/lexikon">Lexikon</a><span class="sep">&nbsp;››&nbsp;</span><a href = "<?php echo $linkBread1 ?>"><?php echo $txtBread1 ?></a><span class="sep">&nbsp;››&nbsp; </span><span class="letzt"><?php echo $txtBread2 ?></span>
<?php } 
 } else { 
if ( $txtBread2 == "Lexikon") {     ?>
<span class="letzt"><?php echo $txtBread2 ?></span>
<?php } 
else { ?>
<a href = "/lexikon">Lexikon</a><span class="sep">&nbsp;›› &nbsp; </span><span class="letzt"><?php echo $txtBread2 ?></span>
<?php }
}
?>
</p>
...
div.top-desk div.main_menue a.weine {width: 70px;}   
div.top-desk div.main_menue a.weinliste {width: 95px;}   
