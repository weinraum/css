...
if ( isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']) ){
$ag_customer = $_SESSION['customer']['name']." ". $_SESSION['customer']['family_name'];
}
if ( (isset($_SESSION['customer']['id']) AND !is_numeric($_SESSION['customer']['id'])) OR !isset($_SESSION['customer']['id']) ){
$ag_customer = "";
}
?>
<header>    
...
<a href="/weinliste/weine_waehlen" class="unten"><span class="li">_______</span><span class="txt">Seit 1998</span><span class="re">_______</span></a>
</div>
<div class="d-none d-sm-block office col-6 col-lg-10">
<p class="knopfleiste ">
<?php if ( !isset($_nohead_spam) OR (isset($_nohead_spam) && $_nohead_spam !== 1) ) { ?>
...
<a href="/weinraum/<?php echo (isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']))?'mw_orderedWines':'anmelden'?>" class="konto ">
...
<p class="knopfleiste "><a href="/weinraum/<?php echo (isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']))?'mw_orderedWines':'anmelden'?>" class="ag-name"><?php echo $ag_customer;?></a></p>
</div> 
...
<div class="d-block d-md-none main_menue"><p class="menmob">
<span class="menue-switch-button-winzer <?php echo((isset($nav_show_weinliste) == 1 AND $nav_show_weinliste == 'yes') ? ' active' : '') ?> " >Weinliste</span>
...
</p><p class="linie unten ">&nbsp;</p>
</div>
<div class="d-none d-md-block box_main_men">
<div class="main_menue">
<a href="/weinliste/weine_waehlen" class="weine 3 <?php echo((isset($nav_show_weinliste) == 1 AND $nav_show_weinliste == 'yes') ? ' active' : '') ?>">Weinliste</a>
<a href="/weine/index" class="weine 3 <?php echo((isset($nav_show_weine) == 1 AND $nav_show_weine == 'yes') ? ' active' : '') ?>">Weine</a>
<a href="/weinraum/kontakt" class=" kontakt <?php echo((isset($class) AND $class== 'kontakt' ) ? ' active' : '') ?>">Kontakt</a>
<!-- <a href="/sale" class=" sale"><img src="/_/img/240330-sale.png" alt="Wein Angebote reduziert" class="sale img-responsive" loading='lazy'/></a> -->
</div>     
...
<?php if ( isset($show_weinraum_bread) AND $show_weinraum_bread == "yes") {?>
<div class=" bread-inner weinraum">
<?php ?>
<p><a href = "/weinraum/anmelden">Mein Konto</a><span class="sep">&nbsp;›› </span><span class="letzt"><?php echo $txtBread2 ?></span></p>
<?php } 
if ( $navigation == "wein"  ) {?>
<div class=" bread-inner wein">
<?php ?>
<p><a href = "/wein">Weine</a><?php if ( $class != "wein" ) { ?> <span class="sep">&nbsp;›› </span><?php } ?>
<?php
...
<?php
if($App::isAdmin() ):     ?>
<li <?php echo($sub_navi == 'admin_tg' ? ' class="active"' : '') ?>><a href="/admin_themengarten">Beitrrr</a></li>
<li <?php echo($sub_navi == 'admin_cat' ? ' class="active"' : '') ?>><a href="/admin_category" ><?php echo lang('german_lang.menu_admin_category'); ?></a></li>
<?php endif; ?>
...
<?php echo(( isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']) ) ? $ag_customer  : 'Ihr Konto im weinraum') ?></a> 
<?php echo(( isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']) ) ? '' : '    <li class="active d-none d-sm-block">
...
<li <?php echo($sub_navi == 'admin_tg' ? ' class="active"' : '') ?>><a href="/admin_themengarten"><?php echo lang('german_lang.menu_admin_themengarten'); ?></a></li>
<li <?php echo($sub_navi == 'admin_cat' ? ' class="active"' : '') ?>><a href="/admin_category" ><?php echo lang('german_lang.menu_admin_category'); ?></a></li>
<?php endif; ?>
...
//if  ( $rest == "W") { $color = "Weiß, "; }
//if  ( $rest == "R") { $color = "Rot, "; }
if ( isset($weine['wines'][$prod_ID]['type']) ) { $_type = $App::getLinkfromBracket("[[typ || ".$weine['wines'][$prod_ID]['type']."]]", $linkIdentifers); }
else { $_type = ""; }
...
if ( $weine['wines'][$prod_ID]['aktions_preis'] > 0) { $_showAktPreis = 1;}
if($_anzPack > 0 ) { ?>
...
<?php
if ( $_showAktPreis == 1 ) { ?>
<img src="/_/img/240330-sale.png" alt="Wein Angebote reduziert" class="sale img-responsive" loading='lazy'/>
<?php } ?>
<p class="producer">
 <?php
...
<?php //echo (!$_fi_exists_4fl_v AND $_fi_exists_bild )?"quer":"";?>
...
<?php }
if ( $_showAktPreis == 1 ) { 
$_agProz = $App::getMoneyValFormated( ($weine['wines'][$prod_ID]['price']-$weine['wines'][$prod_ID]['aktions_preis'])/$weine['wines'][$prod_ID]['aktions_preis']*100);
?>
<div class="aktion"><div class="aktion-content"><?php echo(" {$weine['wines'][$prod_ID]['content']}l");?></div>
<div class="aktion-preis-aktion">
<?php echo $App::getMoneyValFormated($weine['wines'][$prod_ID]['price']);  ?>&nbsp;&euro; 
</div>
<div class="aktion-preis-statt">statt</div>
<div class="aktion-preis-vorher">
<?php echo $App::getMoneyValFormated($weine['wines'][$prod_ID]['aktions_preis']);  ?>&nbsp;&euro; 
</div>
<div class="aktion-reduktion">
<?php echo $_agProz; ?>%
</div>
</div>
<?php } ?>
...
<div class="no block <?php echo !file_exists($abfr4_fl_v)?"":""; ?>"><span class="number">
<?php 
if ( isset($_SESSION['cart_art'][$weine['wines'][$prod_ID]['prodID']]['number']) AND $_SESSION['cart_art'][$weine['wines'][$prod_ID]['prodID']]['number'] > 0 ) {
...
<?php 
if ( !$_SESSION['watchlist'][$prod_ID] AND ( isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']) ) )   { ?>
<a href="/weinraum/anmelden/merken/<?php echo("$indRow/$prod_ID");  ?>" class="whatch  <?php echo ("$indRow $prod_ID");  ?> ">auf den Merkzettel</a>
<?php }
if ( !$_SESSION['watchlist'][$prod_ID] AND !isset($_SESSION['customer']['id']) )   { ?>
...
if ($weine['wines'][$prod_ID]['no_stock'] == 0  AND !$_SESSION['informlist'][$prod_ID]  AND !isset($_SESSION['customer']['id'])) {    ?>
...
<?php }
if ($weine['wines'][$prod_ID]['no_stock'] == 0  AND !$_SESSION['informlist'][$prod_ID]   AND ( isset($_SESSION['customer']['id']) AND is_numeric($_SESSION['customer']['id']) )) {    ?>
...
div.content-text { font: normal normal 300 14px/25px 'roboto', sans-serif; }
...
div.content-text { font: normal normal 300 15px/29px 'roboto', sans-serif; letter-spacing: 0.0em;}
...
div.head_img {margin: 0 0 35px 0;}
div.head_img img {width: 97.22%;}
/* ----------- menue left   */
...
a.jumpSection.rebsorte  {font: normal italic 100 13px/31px 'georgia', serif !important;width: 100%;height: 29px;padding: 0 0 5px 0px;margin: 0px 0 32px 0;display: block;border-bottom: 1px dotted #f04e0b;color: #f04e0b !important;}
...
.men-left-lexikon img {width: 69%; margin: 0 0 0 0;}
.men-left-lexikon h2 {font: normal italic 100 19px/31px 'Roboto Slab', sans-serif !important; margin: 0 0 0 0;}
.men-left-lexikon a {display: block; font: normal normal 600 17px/31px 'Roboto Slab', sans-serif !important; margin: 20px 0 0 0;}
.men-left-lexikon p.journal {font: normal normal 300 14px/18px 'roboto', sans-serif !important;width: 85%;}
.left-men-winzer .m2-wine-categories p.cat-head-menue {margin: 0 0 0 0; text-transform: uppercase;font: normal normal 400 15px/32px 'roboto', sans-serif;letter-spacing: 0.04em;clear:both;}
...
.left-men-regionen ul  { padding: 0 0 0 5px; }
.left-men-regionen ul.second-menu  { padding: 0 0 0 0px; }
.left-men-regionen ul li.submenu-land a, .left-men-regionen ul li.submenu-land span {font: normal normal 400 17px/32px 'roboto', sans-serif;text-transform: uppercase;letter-spacing: 0.04em;display: block;color: #333333;margin: 12px 0 0 0;}
...
.left-men-regionen ul li.submenu-winzer-land a, .left-men-regionen ul li.submenu-appellation span, .left-men-regionen ul li.submenu-winzer span, .left-men-regionen li.txt {display: block;font: normal normal 500 15px/32px 'roboto', sans-serif;color: #333333;text-transform: uppercase;letter-spacing: 0.04em;margin: 25px 0 0 0;padding: 0 0 0 0 !important;}
...
div.infoProd img.sale {width:65px;height:65px;position:absolute;top:20px;right:-12px; }
div.aktion {position: relative; width: 100%; height: 89px;}
div.aktion div.aktion-content {font: normal normal 400 12px/15px 'roboto',sans-serif !important;width:25%;position:absolute; top: 60px; left:0%; text-align: right;}
div.aktion div.aktion-preis-aktion {font: normal normal 600 17px/19px 'roboto',sans-serif !important;width:82px;height:28px; position: absolute; top: 56px;right: 6px;background-color:#FFF;border:1px solid #d90101; z-index:2; text-align: right;padding: 3px 1px 0 0;letter-spacing: 0.04em;}
div.aktion div.aktion-preis-statt {font: normal normal 400 11px/15px 'roboto',sans-serif !important;color:#b53c3c;width:25%; position: absolute; top: 21px;left: 35%;letter-spacing: 0.04em;}
div.aktion div.aktion-preis-vorher {font: normal normal 400 11px/15px 'roboto',sans-serif !important;text-decoration:line-through;color:#b53c3c;width:75px; position: absolute; top: 21px;right: 3px;letter-spacing: 0.04em;text-align:right;padding: 0 3px 0 0;}
div.aktion div.aktion-reduktion {font: normal normal 600 11px/15px 'roboto',sans-serif !important;text-align:right;padding: 0 3px 0 0;width:75px;height:25px; position: absolute; top: 40px;right: 1%;background-color:#d90101; color:#FFF;}
...
.teaser .basket-line .add_one .no, .teaser .basket-line .add.sold .no {position: absolute;top: -3px;left: 1px;padding: 4px 0px 3px 0px;display:block;width: 42px;height: 42px;background-color: #FFF; border: 3px solid #7ca044;border-radius:21px;}
.teaser .basket-line .add_one .no.quer {width: 25%;}
.teaser .basket-line .add_one .no span.number {font: normal normal 500 15px/17px 'roboto', sans-serif;display: block;float: left;width: 100%;color: #000000;height: 30px;padding: 5px 0px 0 0px;text-align:center;position: relative;top: 2px;left:0px;}
...
.teaser div.cart-box span.txt, .teaser div.cart-leer span.txt{margin: 8px 5px 0 0px;display: block;width: 100%;color: #FFF;float: left;text-align: center;}
...
.teaser .basket-line div.add_one .text_basket.add_bask {right: 0px;top: 1px;display:block;font: normal small-caps 600 15px/18px 'roboto', sans-serif;letter-spacing: 0.06em;width: calc(75%);height: 34px; background-color: #7ca044;border-radius:17px;}
...
.teaser .infoProd p.val span.left { font: normal normal 400 12px/15px 'roboto', sans-serif !important;color: #000;letter-spacing: 1px;text-align: right;width: 25%;margin: 0 10px 0 0;}
.teaser .infoProd p.val span.right { font: normal normal 400 12px/15px 'roboto', sans-serif !important;color: #000;letter-spacing: 1px;text-align: right;margin: 0 0 0 0;}
...
.teaser .infoProd p.val { clear: both;height: 23px;}
...
div.detail-cart-box .add_one .text_basket.add_bask {font: normal normal 600 17px/17px 'roboto', sans-serif;right: 0px;top: 7px;padding: 7px 0 0 0;display: block;font-size: 17px;width: calc(100% - 59px);height: 34px;background-color: #7ca044;}
...
div.detail-cart-box .add_one .no {position: absolute;top: 7px;left: 5px;padding: 2px 0px 3px 0px;display: block;width: 34px;height: 34px;background-color: #FFF;border: 1px solid #7ca044;}
...
div.rebenMenueLinks p, div.zeile_winzer p {font: 300 15px/23px roboto,sans-serif!important;letter-spacing: .08em;margin: 0 0 0 37px;}

@media  (min-width : 768px) {
div.content-ci4 div.content-wrapper { margin: 20px auto 0 auto;}
}
...
div.content-text-image-content, div.content content-text {font: normal normal 300 14px/25px 'roboto', sans-serif;letter-spacing: 0.08em;margin: 35px 0px 12px 0;}
}

@media only screen and (min-width:780px) {
.content-wrapper {margin: 32px 0 0 0;}
div.content-text {padding-left: 0;}
...
div.content-text-image-content, div.content content-text {font: normal normal 300 15px/32px 'roboto', sans-serif;letter-spacing: 0.0em;margin: 0px 0px 12px 0;}
div.content-text-image.zeitung div.content-text-image-content, div.content content-text.zeitung  {font: normal normal 300 14px/24px 'roboto', sans-serif;}
...
div.content-winzer-head a.jumpSection img {width: 105px;display:block; float: left; }
div.content-winzer-head a.jumpSection span.txt {font: normal normal 500 16px/28px 'roboto', sans-serif !important;margin: 42px 0 0px 4px;display:block; float: left; }
div.content-winzer-head h2.winzer.index {clear: both; font: normal normal 300 29px/28px 'roboto-slab', sans-serif !important; margin: 10px 0 25px 0;}
...
div.top-desk div.main_menue a.active {color: #9B0011 !important;}
ul.warenkorb.nav, ul.warenkorb.det, ul.warenkorb.modal { display: none; }
div.top-desk p.linie { line-height: 1px; }
div.top-desk p.linie.unten { clear: both; border-bottom: 1px solid #6f4c4c; margin: 0px 0 5px 0;}
div.top-desk p.linie.oben { border-bottom: 1px solid #6f4c4c; margin: 0px 0 5px 0;}
...
div.top-desk div.main_menue {width: 275px; height: 45px; margin: 0 auto 0 auto;}

div.top-desk div.main_menue a {font: normal small-caps 600 14px/18px 'roboto', sans-serif;  letter-spacing: 0.0em; height: 28px;margin: 2px 5px 0 0;}
div.top-desk div.main_menue p.menmob span {font: normal small-caps 600 14px/18px 'roboto', sans-serif;  letter-spacing: 0.0em; height: 28px;margin: -3px 5px 0 0 !important;}
div.top-desk div.main_menue a.kontakt {width: 50px; margin: 2px 0 0 0 !important;}   
div.top-desk div.main_menue a.sale {width: 35px; margin: 2px 0 0 0 !important;}   
div.top-desk div.main_menue a.sale img {width: 25px;height:32px;margin: 2px 0 0 0 !important;}
...
.bread .letzt {font: normal normal 600 10px/21px 'roboto', sans-serif; letter-spacing: 0.04em; color: #242125;}
}
...
div.top-desk div.brand.desk a.logo {display: block;width: 245px;height: 56px;margin: 0 auto 15px auto;text-align: center;}
div.top-desk div.brand.desk a.logo img { width: 120px; } 
div.top-desk div.main_menue {width: 375px;height:46px;margin: 0 auto 0 auto;}

div.top-desk div.main_menue a {font: normal small-caps 600 14px/18px 'roboto', sans-serif;  letter-spacing: 0.0em; height: 28px;margin: 2px 17px 0 0;}
div.top-desk div.main_menue p.menmob {margin: 0px auto 0 auto;} 
div.top-desk div.main_menue p.menmob span {font: normal small-caps 600 14px/18px 'roboto', sans-serif;  letter-spacing: 0.0em; height: 28px;margin: -3px 17px 0 0;} 
div.top-desk div.main_menue a.kontakt {width: 55px; margin: 2px 0 0 0 !important;}   
div.top-desk div.main_menue a.sale {width: 74px; margin: 2px 0 0 25px !important;}   
div.top-desk div.main_menue a.sale img {width: 32px; margin: 2px 0 0 0 !important;}
...
div.top-desk div.brand.desk a.logo {display: block;width: 245px;height: 56px;margin: 0 auto 15px auto;text-align: center;}
div.top-desk div.brand.desk a.logo img { width: 120px; } 
div.top-desk div.main_menue {width: 465px;height:52px;margin: 0 auto 0 auto;}

div.top-desk div.main_menue a {font: normal small-caps 600 15px/18px 'roboto', sans-serif;  letter-spacing: 0.1em; height: 28px;margin: 2px 18px 0 0;}
div.top-desk div.main_menue p.menmob span {font: normal small-caps 600 15px/18px 'roboto', sans-serif;  letter-spacing: 0.2em; height: 28px;margin: -3px 18px 0 0;}  
div.top-desk div.main_menue a.kontakt {width: 74px; margin: 2px 0 0 0 !important;}   
div.top-desk div.main_menue a.sale {width: 74px; margin: 2px 0 0 15px !important;}   
div.top-desk div.main_menue a.sale img {width: 32px; margin: 2px 0 0 0 !important;}
...
div.top-desk { height: 155px;padding: 20px 0 0 0;}
div.top-desk div.office p.knopfleiste  {height: 25px; margin: 0 0 0 0;}
div.top-desk div.office p.knopfleiste img, div.top-desk div.office p.knopfleiste  a, div.top-desk div.office p.knopfleiste div.wk , div.top-desk div.office p.knopfleiste span {display: block; float: right;}
div.top-desk div.office p.knopfleiste span {font: normal normal 500 10px/16px 'roboto', sans-serif !important; margin: 2px 2px 0 0;}

div.top-desk div.office p.knopfleiste img.suche {width: 17px; height: 17px;  margin: 0px 20px 0 0;}
div.top-desk div.office p.knopfleiste img.warenkorb {width: 17px; height: 17px;  margin: 0px 3px 0 0;}
div.top-desk div.office p.knopfleiste a.konto {margin: 0px 20px 0 0;}
div.top-desk div.office p.knopfleiste mg.konto {width: 17px; height: 17px;  margin: 0px 0px 0 0;}
div.top-desk div.office a.warenkorb { margin: 0 15px 0 0;}
div.top-desk div.office a.warenkorb span {position: absolute;top: 13px;left: 0;margin: 0 !important;font: normal normal 500 16px/15px 'roboto', sans-serif;  letter-spacing: 0.0em;}
div.top-desk div.office a.warenkorb span.bobble {font: normal normal 500 10px/16px 'roboto', sans-serif !important;top: -9px;left: 11px;width: 18px;height: 18px;border-radius: 9px;}
...
div.top-desk div.brand.desk a.logo {display: block;width: 245px;height: 56px;margin: 0 auto 15px auto;text-align: center;}
div.top-desk div.brand.desk a.logo img { width: 120px; } 
div.top-desk div.main_menue {width: 515px;height:38px;margin: 0 auto 0 auto;}

div.top-desk div.main_menue a {font: normal small-caps 600 16px/18px 'roboto', sans-serif;  letter-spacing: 0.2em; height: 28px;margin: 2px 21px 0 0;}
div.top-desk div.main_menue p.menmob span {font: normal small-caps 600 16px/18px 'roboto', sans-serif;  letter-spacing: 0.2em; height: 28px;margin: -3px 21px 0 0;}  
div.top-desk div.main_menue a.kontakt {width: 74px; margin: 2px 0 0 0 !important;}   
div.top-desk div.main_menue a.sale {width: 74px; margin: 2px 0 0 0 !important;}   
div.top-desk div.main_menue a.sale img {width: 32px; margin: 2px 0 0 20px !important;}
...
.bread p { width: 100%; height: 20px; margin: 0; padding: 0; line-height: 16px; text-align: center;}
.bread .sep { font: normal normal 500 9px/13px 'roboto', sans-serif;  letter-spacing: 0.04em; color: #000;  }
.bread a { font: normal normal 600 9px/13px 'roboto', sans-serif;  letter-spacing: 0.04em;  }
.bread .letzt {font: normal normal 600 9px/21px 'roboto', sans-serif;  letter-spacing: 0.04em; color: #242125;}
}

@media(min-width:768px) {   
div.kopf { height: 75px; max-width: 1460px; margin: 0 2% 0 2%; }
div.top-desk { height: 155px;padding: 20px 0 0 0;}
div.top-desk div.office p.knopfleiste {height: 25px; margin: 0 0 0 0;}
div.top-desk div.office p.knopfleiste img, div.top-desk div.office p.knopfleiste  a, div.top-desk div.office p.knopfleiste div.wk , div.top-desk div.office p.knopfleiste span {display: block; float: right;}
div.top-desk div.office p.knopfleiste img.suche {width: 20px; height: 20px;  margin: 0px 40px 0 0;}
div.top-desk div.office p.knopfleiste img.warenkorb {width: 20px; height: 20px;  margin: 0px 10px 0 0;}
div.top-desk div.office p.knopfleiste a.konto {margin: 0px 20px 0 0;}
div.top-desk div.office p.knopfleiste img.konto {width: 20px; height: 20px;  margin: 0px 20px 0 0;}
div.top-desk div.office p.knopfleiste span {font: normal normal 500 14px/16px 'roboto', sans-serif !important; margin: 2px 2px 0 0;}

div.top-desk div.office a.warenkorb { margin: 0 15px 0 0;}
div.top-desk div.office a.warenkorb span {position: absolute;top: 13px;left: 0;margin: 0 !important;font: normal normal 500 16px/15px 'roboto', sans-serif;  letter-spacing: 0.0em;}
div.top-desk div.office a.warenkorb span.bobble {font: normal normal 500 10px/16px 'roboto', sans-serif !important;top: -9px;left: 11px;width: 18px;height: 18px;border-radius: 9px;}
div.top-desk div.office p.knopfleiste a.ag-name {font: normal normal 500 10px/16px 'roboto', sans-serif !important; display: block; float: right;margin: 0px 157px 0 0;}

div.top-desk div.office {height: 25px;margin: 0px 0 5px 0; padding: 23px 0 0 0;}
div.top-desk div.brand.desk {  padding: 15px 0 0 0;}
div.top-desk div.brand.desk a.weinraum { font: normal normal 700 35px/25px 'roboto', sans-serif; letter-spacing: 0.18em; width: 245px;margin: 0 0 0 0px;text-align: left;text-transform:uppercase;}
div.top-desk div.brand.desk span { display: block; float: left;}
div.top-desk div.brand.desk span.li { font: normal normal 500 10px/16px 'roboto', sans-serif;  letter-spacing: 0em; width: 47px;text-align: left;}
div.top-desk div.brand.desk span.txt { font: normal normal 500 10px/22px 'roboto', sans-serif;  letter-spacing: 0.6em; width: 133px;}
div.top-desk div.brand.desk span.re { font: normal normal 500 10px/16px 'roboto', sans-serif;  letter-spacing: 0em; width: 45px;text-align: right;}

div.top-desk div.brand.desk a.unten { font: normal normal 600 9px/18px 'roboto', sans-serif;  letter-spacing: 0.1em; width: 245px;margin: 3px 0 0 0px; height: 22px;text-align: center;}
div.top-desk div.brand.desk a.logo {display: block;width: 245px;height: 56px;margin: 0 auto 15px auto;text-align: center;}
div.top-desk div.brand.desk a.logo img { width: 120px; } 

div.top-desk div.box_main_men {width: 655px;margin: 0px auto 0 auto;}
div.top-desk div.main_menue {width: 575px;margin: 35px auto 0 auto;}
div.top-desk div.main_menue a {display: block;float: left;font: normal small-caps 600 18px/18px 'roboto', sans-serif;  letter-spacing: 0.1em; height: 28px;margin: 0px 28px 0 0;}
div.top-desk div.main_menue a.kontakt {width: 28px; margin: 0 0 0 0 !important;}   
div.top-desk div.main_menue a.weine {width: 120px;}   
div.top-desk div.main_menue a.winzer {width: 80px;}   
div.top-desk div.main_menue a.regionen {width: 94px;} 
div.top-desk div.main_menue a.kontakt {width: 70px;} 
div.top-desk div.main_menue a.journal {width: 70px;} 
div.top-desk div.main_menue a.sale {display: block;height: 55px;width: 55px;margin: -12px 0px 0 0px !important;} 
div.top-desk div.main_menue a.sale img {float: right; width: 35px;} 
...
.bread p { width: 100%; height: 20px; margin: 0; padding: 0; line-height: 16px; text-align: center;}
.bread .sep { font: normal normal 500 9px/13px 'roboto', sans-serif;  letter-spacing: 0.04em; color: #000;  }
.bread a { font: normal normal 600 10px/13px 'roboto', sans-serif;  letter-spacing: 0.04em;  }
.bread .letzt {font: normal normal 600 10px/21px 'roboto', sans-serif;  letter-spacing: 0.04em; color: #242125;}
}
...
div.top-desk { height: 200px;padding: 20px 0 0 0;}
div.top-desk div.office {height: 25px;margin: 0px 0 5px 0; padding: 23px 0 0 0;}
div.top-desk div.brand.desk {  padding: 15px 0 0 0;}
div.top-desk div.brand.desk a.weinraum { font: normal normal 700 35px/25px 'roboto', sans-serif; letter-spacing: 0.18em; width: 245px;margin: 0 0 0 0px;text-align: left;text-transform:uppercase;}
div.top-desk div.brand.desk span { display: block; float: left;}
...
div.top-desk div.main_menue a.kontakt {width: 70px;} 
div.top-desk div.main_menue a.journal {width: 70px;} 
div.top-desk div.main_menue a.sale {display: block;height: 55px;width: 55px;margin: -20px 0px 0 20px !important;} 
div.top-desk div.main_menue a.sale img {float: right; width: 55px;} 

.menue_wein_left { margin: 0 0px 30px 0px !important; }
div.top-desk div.bread div.bread-inner { width: 100%;text-align: center; }
div.top-desk div.bread { padding: 0 5px 0px 0px !important;min-height: 30px;} 
.bread p { width: 100%; max-width: 1460px; height: 20px; margin: 0; padding: 0; line-height: 16px; text-align: center;}
.bread .sep { font: normal normal 500 9px/13px 'roboto', sans-serif;  letter-spacing: 0.04em; color: #000;  }
.bread a { font: normal normal 600 12px/13px 'roboto', sans-serif;  letter-spacing: 0.1em;  }
.bread .letzt {font: normal normal 600 12px/21px 'roboto', sans-serif;  letter-spacing: 0.1em; color: #242125;}
}
...
div.cartPack  { padding: 0 0 19px 0; margin: 0 0 45px 0; border-bottom: 1px dotted #9B0011;}
div.cartPack p.details { clear: both;}
div.cartPack p.details.pakete span { display: block;float: left; text-align: right;}
div.cartPack p.details.pakete span.icon { width: 12px; }
div.cartPack p.details.pakete span.space { width: 50px; margin: 0 0 0 65px;}
div.cartPack p.details.pakete a.a-li { display: block;float: left; width: 15px; margin: 0 0 0 35px;}
div.cartPack p.details.pakete a.a-re  {display: block;float: left; width: 15px;  margin: 0 0 0 5px;}
div.cartPack p.details.pakete span.number {width: 15px; margin: 0 0 0 5px;} 
div.cartPack p.details.pakete div.pad span { width: 15px; margin: 0 0 0 15px;}
div.cartPack p.details.pakete span.preis { width: 130px; }
div.cartPack p.details.pakete span.preisTot { width: 130px; }
div.cartPack p.details.pakete span.icon img { width: 100%;margin: -7px 0 0 15px; }

div.cartPack p.head.pakete span {display: block;float: left;  }
div.cartPack p.head.pakete span.fla {width: 80px; margin: 7px 0 0 43px; }
div.cartPack p.head.pakete span.einz {width: 130px; margin: 7px 0 0 33px; }
div.cartPack p.head.pakete span.anz {margin: 7px 0 0 5px; }
div.cartPack p.head.pakete span.ges {width: 130px; margin: 7px 0 0 37px; }
...
div.cartPack p.details span, div.cartPack  p.details a { font: normal normal 600 14px/16px 'roboto', sans-serif; }
...
div.cartPack p.head.pakete span { font: italic normal 800 16px/16px 'roboto', sans-serif; }
}
...
.modal-warenkorb .text .produkt .details p.cont.preis{ font: normal normal 800 18px/16px 'roboto', sans-serif; }
div.cartPack div.name { font: italic normal 600 25px/16px 'roboto', sans-serif; color: #d12600; letter-spacing: 0.04em; }
div.cartPack p.details span, div.cartPack  p.details a { font: normal normal 800 18px/16px 'roboto', sans-serif; }
}
...
div.modal-menue p.menmob span.menue-switch-button-info {font: normal small-caps 600 14px/12px 'roboto', sans-serif;letter-spacing: 0.04em;color:#ddd; margin: 0 0 0 20px;}
@media(max-width:767px) {
...
@font-face {font-family: 'roboto';font-style: normal;font-weight: 300;font-display: auto;src: local(''),url('/_/css/fonts/titillium-web-v17-latin-300.woff2') format('woff2');}
@font-face {font-family: 'roboto';font-style: italic;font-weight: 400;font-display: auto;src: url('/_/css/fonts/titillium-web-v17-latin-italic.woff2') format('woff2');}
@font-face {font-family: 'roboto';font-style: normal;font-weight: 400;font-display: auto;src: url('/_/css/fonts/titillium-web-v17-latin-regular.woff2') format('woff2');}
@font-face {font-family: 'roboto';font-style: normal;font-weight: 600;font-display: auto;src: url('/_/css/fonts/titillium-web-v17-latin-600.woff2') format('woff2');}
@font-face {font-family: 'roboto';font-style: normal;font-weight: 700;font-display: auto;src: url('/_/css/fonts/titillium-web-v17-latin-700.woff2') format('woff2');}
